...
user_pref("browser.aboutHomeSnippets.updateUrl", "$SNIPPET_HOST/%STARTPAGE_VERSION%/$SNIPPET_PRODUCT_NAME/%VERSION%/%APPBUILDID%/%BUILD_TARGET%/%LOCALE%/%CHANNEL%/%OS_VERSION%/%DISTRIBUTION%/%DISTRIBUTION_VERSION%/");
